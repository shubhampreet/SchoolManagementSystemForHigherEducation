    ...
    if(isset($_POST['login_btn'])){
        ...
        elseif($login_as === "Admin"){
			...
			if(mysqli_num_rows($run_query) == 1){
                ...
                $msg = "Dear Admin Your Login failed Reason:- Incorrect user details";
            }
        }
        ...
        elseif($login_as === "Student"){
			...
			if(mysqli_num_rows($run_query) == 1){
                ...
                $msg = "Dear Student Your Login failed Reason:- Incorrect student details";
            }
        }
        ...
        elseif($login_as === "Accountant"){
            ...
            if(mysqli_num_rows($run_query) == 1){
                ...
                $msg = "Dear Accountant Your Login failed Reason:- Incorrect student details";
            }
        }
        ...
        elseif($login_as === "Principal"){
            ...
            if(mysqli_num_rows($run_query) == 1){
                ...
                $msg = "Dear Principal Your Login failed Reason:- Incorrect student details";
            }
        }
        ...
        elseif($login_as === "Teacher"){
            ...
            if(mysqli_num_rows($run_query) == 1){
                ...
                $msg = "Dear Teacher Your Login failed Reason:- Incorrect student details";
            }
        }
    }
?>
...
<html>
  <head>
    ...
    <title>School Managment System Login</title>
      ...
      <div class='login-box'>
        <form method='POST' class='login-form' action='login.php'>
          ...
          <div class='form-group btn-container'>
            <button name='login_btn' class='btn btn-primary btn-block'><i class='fa fa-sign-in fa-lg fa-fw'></i>Login</button>
          </div>
        </form>

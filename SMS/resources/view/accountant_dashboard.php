...
<html>
  <head>
    ...
    <title><?php echo $accountant_name; ?> School Managment system</title>
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-6 col-xs-6'>
                                    <div class='alert alert-success'>
                                        <p>Transaction ID:  <b>D{$std_name}{$std_regno}4579356006{$transaction_id}</b></p>
                                        ...
                                        <p>Amount paid: <b>Rupess{$fee_amount_paid}</b></p>
                                        <p>Balance: <b>Rupess{$fee_payment_balance}</b></p>
                        ...
                        <div class='col-md-3'>
                            <a href='accountant_dashboard.php?fee_payment'>
                                <div class='card'>
                                    ...
                                    <center><img src='../../img/payy.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class='col-md-3'>
                            <a href='accountant_dashboard.php?outsatanding_bills'>
                                <div class='card'>
                                    ...
                                    <center><img src='../../img/bi.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class='row'>
                        <div class='col-md-3'>
                            <a href='accountant_dashboard.php?manage_expenses'>
                                <div class='card'>
                                    ...
                                    <center><img src='../../img/esp.jpg' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class='col-md-3'>
                            ...
                            <div class='card'>
                                ...
                                <center><img src='../../img/shl.png' class='img-responsive' style='width: 30%;' /></center>
                            </div>
                            </a>
                        </div>
                        ...
                        <div class='col-md-3'>
                            <a href='accountant_dashboard.php?staff_payroll'>
                                <div class='card'>
                                    ...
                                    <center><img src='../../img/pys.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
                    </div>

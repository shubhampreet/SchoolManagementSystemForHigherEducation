...
<div class="page-title hidden-print">
  <div>
    <h1><i class="fa fa-money"></i> View Fees by Class</h1>
  </div>
</div>
<div class="card">
    <div class = 'row'>
        <div class = 'col-xs-12 col-sm-12 col-md-12 shift'>
            <div class = 'panel panel-primary ch'>
                <div class = 'panel-heading'>
                    <h4 class = 'txt'>View Fees for a particular Class</h4>
                </div><br/>
                ...
                if(mysqli_num_rows($run_query) > 0){
                    ...
                    echo"
                        <div class='table-responsive noprint'>
                            <h3 class='text-center text-info'><span class='text-success'><b>{$view_fee_payment_term}</b></span> Fee Payment Records for <span class='text-success'><b>{$view_fee_payment_class} Students</b></span> in <span class='text-success'><b>{$view_fee_payment_session} Session</b></span></h3>
                            <table class='table table-bordered'>
                                <thead class=''>
                                    <tr class='bg-primary'>
                                        ...
                                        <th>TERM</th>
                                        <th>SESSION</th>
                                        <th class=''>AMOUNT PAID (Rupess)</th>
                                        <th class=''>BALANCE (Rupess)</th>
                                        <th>Cash/Online</th>
                                        <th>DATE</th>
                                        <th>STATUS</th>
                                        <!--<th>RECEIPT</th>-->

                    ...
                    <div class='col-xs-12 col-sm-12 col-md-12'>
                        <table class='table table-striped'>
                            ...
                            <tr>
                                <td>Exp. (IN Years)</td>
                                <td>
                                    <input type='text' name='next_of_kin' value = ''placeholder='2,3,4,...Years' class='form-control' required>
                                </td>
                            </tr>
                            <tr>
                                <td>Relationship Status:</td>
                                <td>
                                    <input type='text' name='relationship' value = ''placeholder='Single,Married,None' class='form-control' required>
                                </td>
                            </tr>
                            <tr>

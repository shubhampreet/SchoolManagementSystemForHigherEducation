        ...
        <div class='row'>
            <div class='col-xs-12 col-md-12 text-center'>
                <em>
                    ...
                    <br/>
                    <span class='fa fa-phone'></span> 98282040XX,&nbsp;&nbsp;
                    <span class='fa fa-envelope'></span> jmb.school.desk2021@gmil.com &nbsp;&nbsp;
                    ...
                    <a class='noprint btn btn-danger' href='modules.php?view_students'><i class='fa fa-remove'></i> Close Slip</a> 
                </em>
            </div>
        </div>

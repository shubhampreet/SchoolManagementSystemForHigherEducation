        ...
        <div class="timeline">
          <div class="post">
            <div class="post-media"><a href="#"></a>
              <div class="content">
                <h5><a href="#">Phone:+91 <?php echo $principal_phone; ?></a></h5>
                ...
                <h5><a href="#">Emergency Contact/Email: <?php echo $principal_nok; ?></a></h5>
                <h5><a href="#">Telephone: <?php echo $principal_nok_phone; ?></a></h5>

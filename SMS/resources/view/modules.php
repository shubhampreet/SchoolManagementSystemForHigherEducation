...
<html>
  <head>
    ...
    <title><?php echo $user_fullname; ?> SMS</title>
  ...
  <body class='sidebar-mini fixed'>
    <div class='wrapper'>
      <!-- Navbar-->
      <header class='main-header hidden-print'><a class='logo' href='index.html'>Digital School</a>
        ...
        <section class='sidebar'>
          ...
          <ul class='sidebar-menu'>
            ...
            <li><a href='modules.php?view_attendance_records'><i class='fa fa-eye'></i><span>View Attendance Records</span></a></li>
			 <li><a href='pdfexam.html'><i class='fa fa-comment'></i><span>Examination Instruction</span></a></li>
            ...
            elseif(isset($_GET['logout'])){
                ...
                echo"
                        ...
                        <div class='col-md-3'>
                            <a href='modules.php?view_students'>
                                <div class='card'>
                                    ...
                                    <center><img src='../../img/dg.jpg' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class='col-md-3'>
                            <a href='modules.php?view_classes'>
                                <div class='card'>
                                    ...
                                    <center><img src='../../img/cls.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class='col-md-3'>
                            <a href='modules.php?view_added_subjects'>
                                <div class='card'>
                                    ...
                                    <center><img src='../../img/learning.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-md-3'>
                            <a href='modules.php?allocate_class_fee'>
                            <div class='card'>
                                <h4 class='card-title text-center'>Fee Manager</h4>
                                <center><img src='../../img/ft.png' class='img-responsive' style='width: 30%;' /></center>
                            </div>
                            </a>
                        </div>
                        ...
                        <div class='col-md-3'>
                            <a href='modules.php?view_teachers_portfolio'>
                                <div class='card'>
                                    ...
                                    <center><img src='../../img/staff.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class='col-md-3'>
                            <a href='modules.php?view_all_admin'>
                                <div class='card'>
                                    ...
                                    <center><img src='../../img/req.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-md-3'>
                            <a href='modules.php?staff_reset_password'>
                                <div class='card'>
                                    ...
                                    <center><img src='../../img/security-system.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
						...
						<div class='col-md-3'>
                            <a href='modules.php?class_attendance'>
                                <div class='card'>
						...
						<div class='col-md-3'>
                            <a href='modules.php?view_attendance_records'>
                                <div class='card'>
                                    <h4 class='card-title text-center'>Attendance Record</h4>
                                    <center><img src='../../img/ar.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
						
						<div class='col-md-3'>
                            <a href='modules.php?manage_school_info'>
                                <div class='card'>
                                    <h4 class='card-title text-center'>Manage School Information</h4>
                                    <center><img src='../../img/school.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
						<div class='col-md-3'>
                            <a href='modules.php?settings'>
                                <div class='card'>
                                    <h4 class='card-title text-center'>Activate Result Pin</h4>
                                    <center><img src='../../img/ahl.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
						
						<div class='col-md-3'>
                            <a href='modules.php?all_contact'>
                                <div class='card'>
                                    <h4 class='card-title text-center'>Phone Book Directory</h4>
                                    <center><img src='../../img/phone-call.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
						
						<div class='col-md-3'>
                            <a href='modules.php?add_teacher'>
                                <div class='card'>
                                    <h4 class='card-title text-center'>Add Teacher</h4>
                                    <center><img src='../../img/raj.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>

...
<html>
  <head>
    ...
    <title><?php echo $lastname; ?> Digital School</title>
    ...
    <div class='wrapper'>
      ...
      <aside class='main-sidebar hidden-print'>
        <section class='sidebar'>
          ...
          <!-- Sidebar Menu-->
			...
			<li><a href='pdfexamad.html'><i class='fa fa-print'></i><span>Examination Instruction</span></a></li>
      ...
      <div class='content-wrapper'>
        <?php
			...
			elseif(isset($_GET['examinst'])){
				require("exam_instruction.html");
			}
            ...
            elseif(isset($_GET['logout'])){
                ...
                echo"
                    ...
                    <div class='row'>
						...
						<div class='col-md-3'>
                            <a href='student_dashboard.php?upload'>
                                <div class='card'>
                                    <h4 class='card-title text-center'>Upload Assignment</h4>
						...
						<div class='col-md-3'>
                            <a href='student_dashboard.php?examinst'>
                                <div class='card'>
                                    <h4 class='card-title text-center'>Examination Instructions</h4>
                                    <center><img src='../../img/exam.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
						 <div class='col-md-3'>
                            <a href='student_dashboard.php?idcard'>
                                <div class='card'>
                                    <h4 class='card-title text-center'>ID Card</h4>
                                    <center><img src='../../img/icard.png' class='img-responsive' style='width: 30%;' /></center>
                                </div>
                            </a>
                        </div>
                    </div>

...
<?php
	...
	if(isset($_POST['student_reg_btn'])){
		...
		$school_name = "SGJVPMJ";
		$gen_password = "{$reg_student_dob}ps{$reg_student_firstname}T{$father_phone}";
                    ...
                    if($run_query == true){
                        $msg = "
                            <div class='alert alert-success alert-dismissible' role='alert'>
                                <b>Registration successfull &nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp Your Registerd Name in Our Database :{$reg_student_lastname} {$reg_student_firstname} &nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp Reg no: {$reg_number} &nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp Password: {$gen_password}</b>
            ...
            <div class = 'panel-body'>
                <div class='row'>
                    <div class='col-xs-12 col-sm-12 col-md-12'>
                            ...
                            <tr>
                                <td>Are You Able to Speak English ?</td>
                                <td>
                                    <input type='text' class='form-control' name='reg_student_lga' placeholder='Yes or No' value = ''required>	
                                </td>
                            </tr>
                            <tr>
                                <td>City</td>
